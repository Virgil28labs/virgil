...
async function startServer() {
  try {
    ...
    const server = app.listen(PORT, () => {
      ...
      console.log(
        `⚡ Ready check: http://localhost:${PORT}/api/v1/health/ready`,
      );
      ...
      console.log(
        `  GET /api/v1/weather/coordinates/:lat/:lon - Weather by coordinates`,
      );
      ...
      console.log(
        `  GET /api/v1/elevation/coordinates/:lat/:lon - Elevation by coordinates`,
      );
      console.log(
        `  POST /api/v1/rhythm/generate - AI-powered rhythm generation`,
      );
