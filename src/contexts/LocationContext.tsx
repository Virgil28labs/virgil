...
export function LocationProvider({ children }: LocationProviderProps) {
  ...
  const value: LocationContextValue = useMemo(
    ...
    [state, fetchLocationData, requestLocationPermission, clearError],
  );
