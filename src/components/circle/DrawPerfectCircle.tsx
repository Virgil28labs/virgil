...
export const DrawPerfectCircle = memo(function DrawPerfectCircle({
  ...
  const evaluateCircle = useCallback((points: Point[]): EvaluationResult => {
    ...
    const maxClosureDistance =
      avgRadius * EVALUATION_CONFIG.maxClosureDistanceFactor!;
    ...
    let totalScore = Math.round(
      (varianceScore * EVALUATION_CONFIG.varianceWeight! +
        closureScore * EVALUATION_CONFIG.closureWeight!) *
        100,
    );
  ...
  const getTouchPos = useCallback(
    (e: React.TouchEvent<HTMLCanvasElement>): Point | null => {
    ...
    >
      ...
      >
        ...
        <div className="circle-game-canvas-container">
          ...
          {result && (
            <div className="circle-game-result">
              ...
              <button onClick={clearCanvas} className="circle-game-try-again">
                Try again
              </button>
            </div>
          )}
        ...
        <div className="circle-game-controls">
          <button onClick={clearCanvas} className="circle-game-control-button">
            Clear
          </button>
          <button
            onClick={() => {
