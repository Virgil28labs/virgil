...
const GiphyGalleryInner = memo(function GiphyGalleryInner({
  isOpen,
  onClose,
}: GiphyGalleryProps) {
  const {
        ...
        <div className="giphy-gallery-content">
          {error && (
            <div className="giphy-error">
              ...
              <button className="giphy-error-retry" onClick={clearError}>
                Dismiss
              </button>
            </div>
          )}
...
export const GiphyGallery = memo(function GiphyGallery(
  props: GiphyGalleryProps,
) {
  return (
