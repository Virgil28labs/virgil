...
import type { TagType, ActionType } from '../types';
...
export const TAG_PATTERNS: Record<TagType, RegExp> = {
  ...
  health: /\b(health|doctor|medicine|exercise|workout|gym|diet|sleep|pain|symptom|wellness|mental|therapy|sick|hospital|fitness|meditation|stress|anxiety|energy|weight|nutrition)\b/i,
  money: /\b(money|finance|budget|bill|expense|pay|salary|invest|save|spend|cost|price|tax|loan|debt|credit|shopping|purchase|rent|mortgage|income|wealth)\b/i,
  people: /\b(family|friend|relationship|wife|husband|partner|child|parent|sibling|social|party|birthday|wedding|date|love|friendship|colleague|neighbor|community|network)\b/i,
  growth: /\b(learn|growth|skill|course|class|book|read|improve|develop|practice|training|spiritual|religion|faith|meditation|mindfulness|self-improvement|goal|achievement)\b/i,
