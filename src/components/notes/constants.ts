...
export const TAG_DESCRIPTIONS = {
  ...
  health:
    "fitness, medical, wellness, mental health, self-care, diet, exercise, therapy",
  money:
    "finance, budget, bills, expenses, investments, purchases, savings, income",
  people:
    "relationships, family, friends, social, community, communication, networking",
  growth:
    "learning, skills, personal development, spirituality, self-improvement, courses",
...
export const ACTION_DESCRIPTIONS = {
  ...
  reflect:
    'journal entries, personal narratives, feelings, "I felt", introspection, diary',
} as const;
