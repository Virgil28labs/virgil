...
describe("CircleGameButton", () => {
  ...
  it("renders the circle game button", () => {
    ...
    const button = screen.getByRole("button", {
      name: /open perfect circle game/i,
    });
    expect(button).toBeInTheDocument();
    expect(button).toHaveAttribute(
      "title",
      "Draw Perfect Circle - Can you draw a perfect circle?",
    );
  });
  ...
  it("has correct accessibility attributes", () => {
    ...
    expect(button).toHaveAttribute(
      "aria-label",
      "Open Perfect Circle Game - Test your drawing skills!",
    );
    expect(button).toHaveAttribute(
      "title",
      "Draw Perfect Circle - Can you draw a perfect circle?",
  ...
  it("closes the circle game when close button is clicked", async () => {
    ...
    const closeButton = screen.getByRole("button", {
      name: /close circle game/i,
    });
    await user.click(closeButton);

    await waitFor(() => {
      expect(
        screen.queryByTestId("draw-perfect-circle"),
