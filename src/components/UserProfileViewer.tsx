...
export const UserProfileViewer = memo(function UserProfileViewer({
  ...
  const { deviceInfo, permissions, requestPermission } =
    useDeviceInfo(ipLocation);
  const {
    profile,
  ...
  useEffect(() => {
    const handleClickOutside = (e: MouseEvent) => {
      ...
      if (
        !target.closest(".user-profile-viewer") &&
        !target.closest(".virgil-logo-button")
      ) {
        onClose();
      }
    };
          ...
          <div className="profile-user-info">
            ...
            <div className="profile-user-details">
              <div className="profile-user-name">
                {profile.fullName || profile.nickname || "User"}
              </div>
            ...
            >
              {profileLoading ? (
                ...
                <div className="profile-cards-container">
                  ...
                  {/* Address Card */}
                  <div
                    className={`profile-card address-card ${showAddress ? "expanded" : ""}`}
                  >
                    <div
                  ...
                  {(saving || saveSuccess) && (
                    <div className="save-progress-container">
                      <div
                        className={`save-progress-bar ${saveSuccess ? "success" : ""}`}
                      >
                  ...
                  <div className="virgil-data-section">
                    ...
                    <div className="virgil-data-grid">
                      ...
                      <div className="data-point">
                        ...
                        <span className="data-value">
                          {deviceInfo.screen} @{deviceInfo.pixelRatio}x
                        </span>
                      </div>
                      <div className="data-point live">
                        <span className="data-icon">🪟</span>
                      ...
                      <div className="data-point">
                        ...
                        <span className="data-value">
                          {deviceInfo.colorScheme === "dark" ? "Dark" : "Light"}
                        </span>
                      </div>
                      <div className="data-point">
                        <span className="data-icon">🧮</span>
                        ...
                        <span className="data-value">
                          {deviceInfo.cpu}{" "}
                          {typeof deviceInfo.cpu === "number" ? "cores" : ""}
                        </span>
                      </div>
                      <div className="data-point">
                        <span className="data-icon">💾</span>
                      ...
                      <div className="data-point">
                        <span className="data-icon">
                          {deviceInfo.tabVisible ? "👀" : "😴"}
                        </span>
                        <span className="data-label">Tab</span>
                        <span className="data-value">
                          {deviceInfo.tabVisible ? "Active" : "Hidden"}
                        </span>
                      </div>
                      <div className="data-point live">
                        <span className="data-icon">⏳</span>
                        ...
                        <span className="data-value">
                          {Math.floor(deviceInfo.sessionDuration / 60)}:
                          {(deviceInfo.sessionDuration % 60)
                            .toString()
                            .padStart(2, "0")}
                        </span>
                      </div>
