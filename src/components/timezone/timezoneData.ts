...
export const TIMEZONE_DATABASE: TimezoneInfo[] = [
  // North America - Popular
  {
    ...
    region: 'Eastern',
    popular: true,
    searchTerms: ['new york', 'nyc', 'eastern', 'est', 'edt', 'us east', 'america/new_york'],
  },
  {
    ...
    region: 'Pacific',
    popular: true,
    searchTerms: ['los angeles', 'la', 'pacific', 'pst', 'pdt', 'us west', 'california', 'america/los_angeles'],
  },
  {
    ...
    region: 'Central',
    popular: true,
    searchTerms: ['chicago', 'central', 'cst', 'cdt', 'us central', 'america/chicago'],
  },
  {
    ...
    region: 'Mountain',
    popular: false,
    searchTerms: ['denver', 'mountain', 'mst', 'mdt', 'us mountain', 'america/denver'],
  },
  {
  ...
  // Europe - Popular
  {
    ...
    popular: true,
    searchTerms: ['london', 'uk', 'britain', 'gmt', 'bst', 'united kingdom', 'europe/london'],
  },
  {
  ...
  },
  {
    ...
    country: 'Germany',
    popular: true,
    searchTerms: ['berlin', 'germany', 'deutschland', 'cet', 'cest', 'europe/berlin'],
  },
  {
  ...
  },
  {
    ...
    country: 'Netherlands',
    popular: false,
    searchTerms: ['amsterdam', 'netherlands', 'holland', 'cet', 'cest', 'europe/amsterdam'],
  },
  {
    ...
    country: 'Switzerland',
    popular: false,
    searchTerms: ['zurich', 'switzerland', 'swiss', 'cet', 'cest', 'europe/zurich'],
  },
  ...
  },
  {
    ...
    country: 'India',
    popular: true,
    searchTerms: ['mumbai', 'india', 'bombay', 'delhi', 'ist', 'asia/mumbai', 'asia/kolkata'],
  },
  {
  ...
  },
  {
    ...
    region: 'Eastern',
    popular: false,
    searchTerms: ['melbourne', 'australia', 'aest', 'aedt', 'australia/melbourne'],
  },
  {
  ...
  // Other Important
  {
    ...
    country: 'New Zealand',
    popular: false,
    searchTerms: ['auckland', 'new zealand', 'nzst', 'nzdt', 'pacific/auckland'],
  },
  {
