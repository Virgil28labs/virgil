...
const TimezoneModal = memo(function TimezoneModal({
  ...
  return (
    ...
    >
      <div ref={modalRef} className="timezone-modal" role="document">
        {/* Header */}
        ...
        <div className="modal-content">
                        ...
                        <div className="timezone-label">
                          {isEditing ? (
                            ...
                            <button
                              type="button"
                              onClick={() =>
                                handleStartEditing(timezone.id, timezone.label)
                              }
          ...
          {!canAddMoreTimezones && (
            <div className="limit-notice">
              <p>
                Maximum of 5 timezones reached. Remove a timezone to add
                another.
              </p>
            </div>
          )}
        ...
        <div className="modal-footer">
          <p className="footer-info">Click labels to edit</p>
        </div>
      </div>
    </div>
  );
