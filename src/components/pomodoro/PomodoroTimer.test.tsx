...
describe("PomodoroTimer", () => {
  ...
  describe("Timer Selection", () => {
    ...
    it("increases time with right arrow key", () => {
      ...
      const panel = screen
        .getByText("🍅 Pomodoro Timer")
        .closest(".pomodoro-panel")!;
  ...
  describe("Motivational Messages", () => {
    it("shows motivational message when timer starts", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText(/Let's do this, TestUser!/),
        ).toBeInTheDocument();
      });
    });
  ...
  describe("Timer Completion", () => {
    it("shows celebration when timer completes", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText(/Fantastic work, TestUser! You crushed it! 🎉/),
        ).toBeInTheDocument();
      });
    });
  });
  ...
  describe("Focus Management", () => {
    it("focuses panel when opened", () => {
      const { rerender } = render(
        <PomodoroTimer isOpen={false} onClose={jest.fn()} />,
      );
