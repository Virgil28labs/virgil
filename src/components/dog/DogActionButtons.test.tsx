...
describe('DogActionButtons', () => {
  ...
  it('shows favorited state when dog is favorited', () => {
    render(<DogActionButtons {...defaultProps} isFavorited />);
  ...
  it('calls onFavoriteToggle when favorite button is clicked', () => {
    ...
    render(<DogActionButtons {...defaultProps} onFavoriteToggle={mockToggle} />);
  ...
  it('applies size classes correctly', () => {
    const { rerender } = render(<DogActionButtons {...defaultProps} size="small" />);
    expect(document.querySelector('.doggo-action-btn--small')).toBeInTheDocument();
    
    rerender(<DogActionButtons {...defaultProps} size="large" />);
    expect(document.querySelector('.doggo-action-btn--large')).toBeInTheDocument();
  });

  it('shows labels when showLabels is true', () => {
    render(<DogActionButtons {...defaultProps} showLabels />);
