...
describe('DogCard', () => {
  ...
  describe('rendering', () => {
    ...
    it('should show favorite button with correct state', () => {
      ...
      rerender(<DogCard {...defaultProps} isFavorited />);
  ...
  describe('image loading', () => {
    it('should handle successful image load', () => {
      ...
      expect(document.querySelector('.doggo-image-skeleton')).not.toBeInTheDocument();
      expect(document.querySelector('.doggo-grid-item')).toHaveAttribute('data-loaded', 'true');
    });
  ...
  describe('accessibility', () => {
    ...
    it('should have proper title attributes', () => {
      ...
      expect(screen.getByLabelText('Download image')).toHaveAttribute('title', 'Download');
      expect(screen.getByLabelText('Copy image')).toHaveAttribute('title', 'Copy image');
    });
