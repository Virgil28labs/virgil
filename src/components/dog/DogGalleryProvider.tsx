...
import type { DogGalleryState, TabType, DogGalleryContextType } from '../../types';
import { DogGalleryContext } from './DogGalleryContextInstance';
...
// Reducer function
function dogGalleryReducer(state: DogGalleryState, action: DogGalleryAction): DogGalleryState {
  switch (action.type) {
    case 'SET_ACTIVE_TAB':
...
// Provider component
export const DogGalleryProvider = memo(function DogGalleryProvider({ children, isOpen = false }: DogGalleryProviderProps) {
